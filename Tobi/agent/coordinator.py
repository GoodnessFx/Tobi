...
logger = logging.getLogger("Tobi.agent.coordinator")
...
_RESEARCHER_PROMPT = """\
<agent_role>Tobi Research Agent</agent_role>
...
_CODER_PROMPT = """\
<agent_role>Tobi Coding Agent</agent_role>
...
_BROWSER_PROMPT = """\
<agent_role>Tobi Browser Agent</agent_role>
...
_SYSTEM_PROMPT = """\
<agent_role>Tobi System Agent</agent_role>
...
<agent_role>Tobi Communications Agent</agent_role>
...
_ANALYST_PROMPT = """\
<agent_role>Tobi Analysis Agent</agent_role>
...
_GENERALIST_PROMPT = """\
<agent_role>Tobi Generalist Agent</agent_role>
...
def _build_profiles() -> dict[AgentType, AgentProfile]:
    ...
    for agent_type, (prompt, name) in prompts.items():
        profiles[agent_type] = AgentProfile(
            ...
            description=f"Specialized {name.lower()} for Tobi",
        )
