...
logger = logging.getLogger("Tobi.qa")
...
class QAAgent:
    ...
    def __init__(self):
        ...
        self.verification_system_prompt = (
            "<role>Strict quality assurance verifier for Tobi, a personal AI assistant.</role>\n"
            ...
            "because Tobi outputs are read aloud.\n"
            "</instructions>\n"
            "<response_format>\n"
    ...
    async def verify(
        ...
        Args:
            ...
            llm: TobiLLM instance for Claude communication
