"""
Tobi Tool Schemas for Claude Tool Use
...
from Tobi.agent import learning as _learning_module
from Tobi.core import proactive as _proactive_module
from Tobi.agent import coordinator as _coordinator_module
...
async def _chrome_extension_status() -> str:
    ...
    return (
        ...
        "to install and enable the Tobi Browser Bridge extension in Chrome."
    )
...
def _get_learning_insights() -> str:
    """Get a summary of Tobi's learning insights."""
...
async def _get_system_health() -> str:
    """Get Tobi system health report with circuit breaker status."""
...
TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        "description": (
            "Sync login sessions from the user's real Chrome browser into Tobi's "
    ...
    # These tools use the Tobi Chrome Extension for direct DOM access in the
    ...
    },
    {
        ...
        "description": (
            "Check whether the Tobi Chrome Extension is currently connected. "
    ...
    },
    {
        ...
        "description": (
            ...
            "that Tobi has executed, their outcomes, and step counts. "
            "Use when the user asks about past tasks or wants to review "
            "what Tobi has done recently."
        ),
        "input_schema": {
            "type": "object",
            "properties": {},
    ...
    # ---- Learning Loop ----
    {
        ...
        "description": (
            "Get a summary of Tobi's learning loop insights, including plan "
            "success rates, tool reliability, and common failure patterns. Use "
            "when the user asks about how well Tobi is performing, what it "
    ...
    },
    {
        ...
        "description": (
            "Get reliability scores for all tools Tobi has used, including "
    ...
    # ---- System Health (Phase 6.1) ----
    {
        ...
        "description": (
            "Get the Tobi system health report, including circuit breaker "
    ...
    # ---- Performance Metrics (Phase 6.2) ----
    {
        "name": "get_perf_stats",
        "description": (
            "Get Tobi performance metrics: request latency, tier usage, "
