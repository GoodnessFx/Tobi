"""
Dispatch Registry for Tobi project builds.
...
logger = logging.getLogger("Tobi.core.dispatch")

DB_PATH = settings.DATA_DIR / "Tobi_dispatch.db"
...
class SuccessTracker:
    ...
    Provides monitoring and analytics for Tobi task execution to enable
