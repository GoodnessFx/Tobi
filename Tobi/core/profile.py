...
logger = logging.getLogger("Tobi.profile")
...
_DEFAULT_PROFILE: dict[str, Any] = {
    ...
    "preferences": {
        ...
        "voice_response_speed": "fast"
    },
    "shortcuts": {},
    "notes": [
        "Privacy and security are the highest priority. All data should remain local whenever possible.",
        "The user expects 100% protection and robust error handling (no breaks)."
    ],
}
