"""Settings API endpoints for Tobi configuration management.

Provides REST endpoints for querying and updating Tobi settings, testing
...
logger = logging.getLogger("Tobi.settings_api")
...
async def get_settings() -> dict:
    """
    Get current Tobi settings (safe subset, no API keys).
...
async def update_settings(updates: dict) -> dict:
    """
    Update Tobi settings and write to .env file.
    ...
    try:
        env_path = settings.Tobi_HOME / ".env"
