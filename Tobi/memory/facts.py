"""
Tobi Fact Extraction Engine (Phase 6.3: Persistent Memory)

Extracts structured facts from conversations and stores them as persistent
knowledge. Facts are things Tobi should remember about the user: their
...
are injected into the system prompt so Tobi can reference them naturally.
...
logger = logging.getLogger("Tobi.memory.facts")
