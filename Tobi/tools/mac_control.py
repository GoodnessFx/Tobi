"""Tobi macOS Control Tools: AppleScript-based automation for Mac apps and system."""
import asyncio
import logging
import subprocess
from typing import Optional

logger = logging.getLogger("Tobi.tools.mac_control")
    ...
    for phrase in _BLOCKED_APPLESCRIPT_PHRASES:
        if phrase in script_lower:
            return False, (
                ...
                "Tobi cannot shut down, restart, sleep, or log out. "
                "To shut down Tobi itself, say 'quit Tobi' or 'exit Tobi'."
            )
