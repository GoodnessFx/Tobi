"""Tobi Shell Command Execution: runs shell commands safely on macOS with timeout."""
import asyncio
import logging
import shlex
import re
...
logger = logging.getLogger("Tobi.tools.shell")
    ...
    for power_cmd in ["shutdown", "reboot", "halt", "poweroff", "pmset sleepnow"]:
        if power_cmd in cmd_lower:
            return False, (
                ...
                "Tobi cannot shut down, restart, or sleep the system."
            )
