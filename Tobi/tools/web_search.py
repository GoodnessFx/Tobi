"""Tobi Web Search: free web search using DuckDuckGo (no API key required)."""
import asyncio
import logging
from typing import Optional

logger = logging.getLogger("Tobi.tools.web_search")
...
async def search_and_read(query: str, max_results: int = 3) -> str:
    ...
    if all_urls:
        from Tobi.tools.web_browse import fetch_page_text
        for url in all_urls:
