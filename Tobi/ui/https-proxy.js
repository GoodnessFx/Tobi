 ...
 *
 * Usage:
 *   Tobi_TLS_CERT=cert.pem Tobi_TLS_KEY=key.pem \
...
const CERT_PATH = process.env.Tobi_TLS_CERT;
const KEY_PATH = process.env.Tobi_TLS_KEY;
const LISTEN_PORT = parseInt(process.argv[2] || "3000", 10);
const TARGET_PORT = parseInt(process.argv[3] || "3001", 10);

if (!CERT_PATH || !KEY_PATH) {
  console.error("Error: Tobi_TLS_CERT and Tobi_TLS_KEY must be set.");
  process.exit(1);
}
