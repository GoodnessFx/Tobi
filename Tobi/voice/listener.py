"""Tobi Voice Listener: microphone input, wake word detection, and speech-to-text."""
import asyncio
import logging
import numpy as np
import time
...
logger = logging.getLogger("Tobi.voice.listener")
...
class VoiceListener:
    ...
    async def listen_loop(self):
        ...
        logger.info("Tobi is listening... Say 'Hey Tobi' to activate.")
            ...
            while self._is_listening:
                ...
                if self._in_followup_window:
                    ...
                    if elapsed_followup > self.FOLLOWUP_WINDOW_SECONDS:
                        self._in_followup_window = False
                        logger.info("Follow-up window closed. Say 'Hey Tobi' to activate.")
                        continue
